...
export default function Footer() {
	return (
		<div className="px-4 md:px-10 lg:px-40 flex flex-1 justify-center py-5 border-t border-border-dark">
			<div className="layout-content-container flex flex-col max-w-[960px] flex-1">
				<footer className="flex flex-col gap-6 px-5 py-10 text-center @container">
					<div className="flex flex-wrap items-center justify-center gap-6 @[480px]:flex-row @[480px]:justify-center">
						<Link
							className="text-text-secondary text-base font-normal leading-normal hover:text-primary transition-colors"
