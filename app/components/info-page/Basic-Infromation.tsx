			...
			<div className="lg:sticky lg:top-24 flex flex-col gap-6">
				...
				<div className="bg-card-dark rounded-2xl border border-gray-800 overflow-hidden shadow-sm relative">
					...
					<div className="px-6 pb-6 -mt-16 relative">
						...
						<div className="grid grid-cols-2 gap-4 mb-6">
							<a
								href="#"
								className="flex flex-col items-center p-3 rounded-xl bg-[#111a22] hover:bg-[#1a252e] transition-colors border border-gray-800 group"
							>
						...
						<div className="space-y-4">
							<div className="flex items-center gap-4 text-sm group">
								<div className="w-9 h-9 rounded-lg bg-[#111a22] flex items-center justify-center text-text-secondary group-hover:text-primary group-hover:bg-primary/10 transition-colors shrink-0">
				...
				<div className="bg-card-dark rounded-2xl border border-gray-800 p-6 shadow-sm">
					<div className="flex items-center justify-between mb-4">
						...
						<span className="text-xs bg-[#111a22] text-text-secondary px-2 py-1 rounded-md">
							3
						</span>
					</div>
					<div className="flex gap-3">
						{ORGANIZATIONS.map((org, index) => (
							<a
								...
								href="#"
								title={org.name}
								className="w-12 h-12 rounded-xl bg-[#111a22] p-2 border border-gray-800 hover:border-primary/50 hover:shadow-md transition-all group"
							>
								<Image
									src={org.logo}
									alt={org.name}
